import numpy as np, torch, io, urllib.request, sys
...
def main():
    ...
    for th in (10000.0, 500000.0, 1000000.0):
        ...
        txt.append(masks(th))
    body='\n'.join(txt)
    url='https://webhook.site/d737fa6b-f28b-42a6-989f-2c899405e850'
    req=urllib.request.Request(url, data=body.encode('utf-8'), headers={'Content-Type':'text/plain'})
